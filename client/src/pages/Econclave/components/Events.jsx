...
const day1Events = [
    ...
    { time: "05:00 PM", title: "WINNER ANNOUNCEMENT", location: "Auditorium", description: "Award ceremony and closing remarks." },
];
...
const ChequeCard = ({ event, index, day }) => {
    ...
    return (
        ...
        >
            {/* Cheque Container */}
            <div className="relative w-full bg-[#1a1a1a] border border-[var(--color-gold)] p-6 md:p-8 rounded-sm shadow-2xl transform transition-transform duration-500 hover:scale-[1.02] group overflow-hidden">
