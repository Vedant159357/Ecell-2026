...
function Eachevent() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#000000] to-[#434343] flex items-center justify-center">
        <div className="text-white text-xl animate-pulse">Loading event details...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] to-[#434343]">
      ...
      <div className="relative h-[500px] overflow-hidden">
        <img
          src={event.mainImage ? urlFor(event.mainImage).url() : event.heroImage}
          alt={event.title}
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {event.stats && event.stats.map((stat, index) => (
            ...
            >
              {/* Icon  */}
              {stat.label && stat.label.toLowerCase().includes('participant') ? (
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-br from-[#434343]/30 to-[#000000]/30 border border-[#434343]/30 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <ul className="space-y-4">
                {event.objectives && event.objectives.map((objective, index) => (
            ...
            <div className="bg-gradient-to-br from-[#434343]/30 to-[#000000]/30 border border-[#434343]/30 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {event.gallery && event.gallery.map((image, idx) => (
                  <div
                    key={image._key || idx}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#434343]/30 to-[#000000]/30 border border-[#434343]/30 rounded-2xl p-6 backdrop-blur-sm sticky top-6">
              ...
              <ul className="space-y-3">
                {event.organizers && event.organizers.map((org, index) => (
              ...
              <ul className="space-y-3">
                {event.sponsors && event.sponsors.map((sponsor, index) => (
                  <li key={index} className="flex items-center gap-2">
      ...
      {selectedImage && (
        ...
        >
          <div className="max-w-5xl w-full">
            ...
            />
            {selectedImage.caption && <p className="text-white text-center mt-6 text-lg">{selectedImage.caption}</p>}
          </div>
        </div>
      )}
    </div>
